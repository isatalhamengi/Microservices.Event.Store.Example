...
//var events = client.ReadStreamAsync(streamName: "order-stream", direction: Direction.Forwards, revision: StreamPosition.Start);
//var datas = await events.ToListAsync();
//Console.WriteLine(datas);

//await client.SubscribeToStreamAsync(streamName: "order-stream", start: FromStream.Start, eventAppeared: async (streamSubscription, resolvedEvent, cancellationToken) =>
//{
...
await eventStoreService.SubscribeToStreamAsync(streamName: "customer - 98765-stream",async (ss,re,ct) =>
{
